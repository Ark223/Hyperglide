...
import dev.arkieee.hyperglide.navigation.Highways;
...
public class Navigation extends Module {
    ...
    /**
     * Zooms the map while scrolling over it in chat.
     *
    ...
    private void frame(DrawContext context, int left, int top) {
        ...
        context.drawBorder(left, top, size, size, color);
    }
    ...
    private boolean vanilla() {
        if (this.mc.currentScreen == null ||
            this.mc.currentScreen instanceof ChatScreen) return false;
    ...
    public static class Mask implements WTextBox.Renderer {
        ...
        public void render(GuiRenderer renderer,
            ...
            renderer.text(value, x, y, color, false);
        }
    }
