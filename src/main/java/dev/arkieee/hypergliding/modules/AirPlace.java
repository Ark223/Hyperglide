...
public class AirPlace extends Module {
    ...
    private final Setting<Boolean> render = this.general.add(new BoolSetting.Builder()
        .name("render")
    ...
    private final Setting<ShapeMode> shape = this.general.add(new EnumSetting.Builder<ShapeMode>()
        .name("shape")
    ...
    private final Setting<SettingColor> side = this.general.add(new ColorSetting.Builder()
        .name("side-color")
    ...
    private final Setting<SettingColor> line = this.general.add(new ColorSetting.Builder()
        .name("line-color")
    ...
    public AirPlace() {
        super(Hypergliding.CATEGORY, "air-place",
    ...
    private void onRender(Render3DEvent event) {
        ...
        event.renderer.box(
            this.hit.getBlockPos(), this.side.get(), this.line.get(),
            this.shape.get(), 0
        );
    }
